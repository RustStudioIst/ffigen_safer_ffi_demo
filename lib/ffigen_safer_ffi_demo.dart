...
import 'ffigen_safer_ffi_demo_bindings_generated.dart';
...
int sum(int a, int b) => a + b /*_bindings.sum(a, b)*/;
...
/// The dynamic library in which the symbols for [FfigenSaferFfiDemoBindings] can be found.
...
final FfigenSaferFfiDemoBindings _bindings = FfigenSaferFfiDemoBindings(_dylib);
    ...
    final ReceivePort helperReceivePort = ReceivePort()
      ..listen((dynamic data) {
        ...
        if (data is _SumRequest) {
          final int result =
              data.a + data.b; //_bindings.sum_long_running(data.a, data.b);
